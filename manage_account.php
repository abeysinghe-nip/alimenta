...
<div class="content py-3"></div>
	<div class="card card-outline rounded-0 card-primary shadow" style="border-top: 3px solid green;">
			...
			<div class="container-fluid">
				...
				<form action="" id="manage-user">	
                    ...
                    <div class="row">
						...
						<small class="text-muted"><i>Leave the New Password Field and Confim Password Field blank if you don't want to update it.</i></small>
                    </div>
                    <br>
					<div class="row">
						<div class="form-group col-md-6">
							<label for="oldpassword" class="control-label">Enter Current Password</label>
							<small class="text-muted"><i> (Must enter the current password to update the profile)</i></small>
							<div class="input-group input-group-sm">
		...
		<div class="card-footer text-center">
				<button class="btn btn-sm btn-primary" form="manage-user" style="background-color: green;">Update</button>
		</div>
	</div>
</div>
<script>
