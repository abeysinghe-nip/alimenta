...
<div class="content py-3">
    <div class="row">
        <div class="col-md-4">
            <div class="card card-outline rounded-0 card-primary shadow" style="border-top: 3px solid green;">
                <div class="card-body">
        ...
        <div class="col-md-8">
            <div class="card card-outline card-primary shadow rounded-0" style="border-top: 3px solid green;">
                <div class="card-body">
                    <div class="container-fluid">
                        ...
                        <div class="row" id="product_list">
                            ...
                            if(isset($_GET['search']) && !empty($_GET['search'])){
                                $swhere .= " and (p.name LIKE '%{$_GET['search']}%' or p.description LIKE '%{$_GET['search']}%' or c.name LIKE '%{$_GET['search']}%') ";
                            }

                            $products = $conn->query("SELECT p.*, c.name as `category` FROM `product_list` p inner join category_list c on p.category_id = c.id where p.delete_flag = 0 and p.status =1 {$swhere} order by RAND()");
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 product-item">
                                ...
                                <div class="product-img-holder position-relative">
                                    ...
                                    <div class="card-body border-top border-gray">
                                        ...
                                        <p class="card-text truncate-3 w-100" style="color: #9be8d3; font-weight:bold;">VIEW PRODUCT</p>
                                    </div>
                                </a>
                            </div>
                            <?php endwhile; ?>
