...
<body class="hold-transition">
  ...
  <div class="d-flex justify-content-center align-items-center flex-row h-100">
        <div class="col-12 h-100 bg-gradient-light px-4">
            <div class="d-flex justify-content-center align-items-center w-100 h-100">
                <div class="card card-outline card-primary col-12 rounded-0 shadow">
                    <div class="card-header text-center" style="margin-top:200px;">
                    ...
                    <form id="cregister-frm" action="" method="post">
                       ...
                       <!-- <div class="row">
                        ...
                        <div class="row align-item-end">
                            ...
                            <!-- /.col -->
                            <div class="col-4">
                                <button type="submit" class="btn btn-primary btn-block btn-flat" style="background-color: green;">Create Account</button>
                            </div>
                            <div class="col-12 text-center">
                            <a href="<?= base_url.'./login.php' ?>" style="color: green;">Already have an Account</a>
                            </div>
                        <!-- /.col -->
                        </div>
                    </form>
